...
topnav: topnav
permalink: /extras/useful-links/
---

## Surveillance Networks

- [SARInet plus](https://sarinet.org) - The Severe Acute Respiratory Infections network, a regional collaboration of hospitals, laboratories, and organizations involved in SARI surveillance in the Americas.
- [PAHO - Influenza, SARS-CoV-2, RSV and Other Respiratory Viruses](https://www.paho.org/en/topics/influenza-sars-cov-2-rsv-and-other-respiratory-viruses) - PAHO's comprehensive resource for surveillance data, guidelines, and technical resources on respiratory viruses in the Americas.
- [RESVIGEN - Respiratory Virus Genomic Surveillance Regional Network](https://www.paho.org/en/topics/influenza-sars-cov-2-rsv-and-other-respiratory-viruses/resvigen-respiratory-virus-genomic) - PAHO's regional network for strengthening genomic sequencing capacity and surveillance of respiratory viruses across Latin America and the Caribbean.
