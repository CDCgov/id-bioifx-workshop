...
topnav: topnav
permalink: /lessons/20-all-presentations/
---

Below are all the workshop presentations available for download.

<table>
  <thead>
    <tr><th>Presentation</th><th>Download</th></tr>
  </thead>
  <tbody>
    ...
    <tr><td>Docker &amp; Common Software</td><td><a href="{{ site.baseurl }}/presentations/Presentation6_Int_Flu_Workshop_Docker_Common-Software_LF.pdf">Presentation6_Int_Flu_Workshop_Docker_Common-Software_LF.pdf</a></td></tr>
    <tr><td colspan="2" style="text-align:center; font-weight:bold; background:#f0f0f0;">Day 3</td></tr>
    <tr><td>NGS Pipelines</td><td><a href="{{ site.baseurl }}/presentations/Presentation7_NGSPipelines.pdf">Presentation7_NGSPipelines.pdf</a></td></tr>
